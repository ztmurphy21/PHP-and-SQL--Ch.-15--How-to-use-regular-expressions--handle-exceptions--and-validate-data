...
switch ($action) {
    ...
    case 'register':
        ...
        $birthdate = filter_input(INPUT_POST, 'birthdate'); // for birthday step 7
        ...
        $validate->birthdate('birthdate', $birthdate);// for birthday step 7
